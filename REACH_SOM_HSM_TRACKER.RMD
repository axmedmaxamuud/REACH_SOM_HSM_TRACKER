...
DT::datatable(reach_bases)
```


# Hight Frequency Checks
```{r}
library(cleaninginspectoR)

check_time <- cleaninginspectoR::check_time(df,duration_threshold_lower = 20,
                                            duration_threshold_upper = 60)
